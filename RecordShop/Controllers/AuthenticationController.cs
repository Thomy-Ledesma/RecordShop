...
namespace RecordShop.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(ICustomerService userService, IConfiguration configuration)
        {
        ...
        {
            Customer? CustomerAuthenticated = null; //agregar autenticacion en repository, inyectar en el controller
